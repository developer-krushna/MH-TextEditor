 ...
 * It utilizes a dedicated thread to continuously read logcat output and send it via a broadcast
 * intent.
 *
 * <p>Usage: - Call `SketchLogger.startLogging()` to begin logging. - Call
 * `SketchLogger.stopLogging()` to stop logging. - Use `SketchLogger.broadcastLog(String)` to
 * manually send a debug log message.
 */
